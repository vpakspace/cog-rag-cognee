...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "graph_nodes": "Nodes",
        "graph_edges": "Edges",
        "graph_filter": "Filter by entity type",
        "graph_load": "Load Graph",
        "graph_loading": "Loading graph data...",
        "graph_error": "Could not load graph data. Is the API running?",
        "graph_stats": "Graph Statistics",
        "graph_entity_breakdown": "Entity Type Breakdown",
        ...
        "upload_docling_missing": "Docling required for this format. Install: pip install docling",
        "upload_error": "Upload error",
        "upload_no_input": "Please upload a file or enter text.",
    ...
    "ru": {
        ...
        "graph_nodes": "Узлы",
        "graph_edges": "Связи",
        "graph_filter": "Фильтр по типу сущности",
        "graph_load": "Загрузить граф",
        "graph_loading": "Загрузка данных графа...",
        "graph_error": "Не удалось загрузить данные графа. API запущен?",
        "graph_stats": "Статистика графа",
        "graph_entity_breakdown": "Распределение по типам",
        ...
        "upload_docling_missing": "Для этого формата нужен Docling: pip install docling",
        "upload_error": "Ошибка загрузки",
        "upload_no_input": "Загрузите файл или введите текст.",
